...
export async function GET(
  ...
  try {
    ...
    const prompt = await AdminPromptService.getById(params.id)
...
export async function PUT(
  ...
  try {
    ...
    const prompt = await AdminPromptService.update(params.id, body)
...
export async function DELETE(
  ...
  try {
    ...
    const prompt = await AdminPromptService.delete(params.id)
